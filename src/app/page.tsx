...
export const metadata: Metadata = {
  ...
  description:
    'Karte turns a personal page into a public inbound agent: it answers visitor questions, collects context, and sends cleaner messages to your inbox.',
    ...
    <main>
      ...
      <div className="onyx-deck">
        <OnyxCard
          idx="i"
          serial="№ 00471"
          kicker="INBOUND AGENT · CARD V2026"
          footL="karte.cc/yourhandle"
          footR="Free · first-pass assistant"
        >
          <OnyxHero />
        </OnyxCard>
        ...
        <OnyxCard
          idx="iii"
          serial="№ 00473"
          kicker="THE INBOUND DESK · CARD III"
          footL="Chat · email · leads · public proof"
          footR="Same memory"
        >
          <OnyxSurfaces />
        </OnyxCard>
        ...
        <OnyxCard
          idx="iv"
          serial="№ 00474"
          kicker="THE ASSISTANT · CARD IV"
          footL="Issued to humans · for their inbound"
          footR="karte.cc/assistant"
        >
          <OnyxAgents />
        </OnyxCard>
